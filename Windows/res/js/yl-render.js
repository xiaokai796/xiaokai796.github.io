    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        if (first && !YL.static.serialNumber) {
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg("Fuxiaokai's Windows", 'Hello，你好，欢迎来到 Windows 小分站！<br/>个人主页：' + '<a style="color: white" target="_blank" href="https://xiaokai796.github.io/"> www.xiaokai796.github.io </a><br />本网站 UI 由 ' + '<a style="color: white" target="_blank" href="https://ylui.yuri2.cn"> YLUI </a> 强力驱动');
            }, 1500)
          });
        }
